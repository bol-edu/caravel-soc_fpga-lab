...
// FPGA:  remove vdd,vss,vcc
    ...
    //For bram connected to block design
    output [31:0] userbram_Addr,
    output userbram_EN,
    output [3:0] userbram_WEN,
    output [31:0] userbram_Din,
    input  [31:0] userbram_Dout,
    output userbram_Clk,
    output userbram_Rst
);
...
// FPGA : Remove mgmt_protect module, passthrough
 ...
 //BRAM
 .userbram_Addr(userbram_Addr),
 .userbram_EN(userbram_EN),
 .userbram_WEN(userbram_WEN),
 .userbram_Din(userbram_Din),
 .userbram_Dout(userbram_Dout),
 .userbram_Clk(userbram_Clk),
 .userbram_Rst(userbram_Rst),
    );
