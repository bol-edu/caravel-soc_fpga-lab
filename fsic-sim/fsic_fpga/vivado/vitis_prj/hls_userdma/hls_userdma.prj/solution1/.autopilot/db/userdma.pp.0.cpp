 ...
 int in_m2s_len, hls::stream<out_data> &out_stream, hls::stream<int> &out_counts) {
  ...
  if(!in_en_clrsts){
   ...
   VITIS_LOOP_99_1: do {
    ...
    VITIS_LOOP_107_2: for (int i = 0; i < count; ++i) {
#pragma HLS PIPELINE
  ...
  bool &buf_sts, bool sts_clear, hls::stream<trans_pkt >& out_stream)
{
    ...
    VITIS_LOOP_149_1: do {
     count = in_counts.read();
     VITIS_LOOP_151_2: for (int i = 0; i < count; ++i) {
#pragma HLS PIPELINE
...
__attribute__((sdx_kernel("userdma", 0))) void userdma(hls::stream<trans_pkt >& inStreamTop,
  ...
  ap_uint<1> m2s_enb_clrsts,
  hls::stream<trans_pkt >& outStreamTop) {
#line 16 "D:/FSIC/hls/userdma_upsb_1204_refine/userdma_upsb_1204_refine/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=userdma
# 180 "userdma.cpp"

#line 6 "D:/FSIC/hls/userdma_upsb_1204_refine/userdma_upsb_1204_refine/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=userdma
# 180 "userdma.cpp"
