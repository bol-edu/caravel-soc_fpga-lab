...
#define XREAD_ROMCODE_CONTROL_ADDR_ROMCODE_TO_PS_DATA 0x1c
#define XREAD_ROMCODE_CONTROL_BITS_ROMCODE_TO_PS_DATA 64
#define XREAD_ROMCODE_CONTROL_ADDR_CMD_DATA           0x28
#define XREAD_ROMCODE_CONTROL_BITS_CMD_DATA           32
