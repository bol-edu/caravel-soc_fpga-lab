...
set solution_dir "/home/allen/fsic-lab1/vitis_hls_project/lab1/solution1"
set debug_dir "/home/allen/fsic-lab1/vitis_hls_project/lab1/solution1/.debug"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_BUS0 m_axi_BUS1"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_BUS1 {
        ...
        preferredUsageValue "MEMORY"
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 64 MAX_WRITE_BURST_LENGTH 16 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE WRITE_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "BUS1"
        ctype {
            AWLEN {
                Type "integer unsigned"
        ...
        data_width "32"
        port_prefix "m_axi_BUS1"
        param_prefix "C_M_AXI_BUS1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
...
source -notrace "/home/allen/vitis/Vitis_HLS/2022.2/common/scripts/ipxhls.tcl"
