...
module read_romcode_read_romcode_Pipeline_VITIS_LOOP_41_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [10:0] i_2_reg_131;
reg   [10:0] i_2_reg_131_pp0_iter1_reg;
reg   [31:0] BUS0_addr_read_reg_140;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln41_fu_115_p1;
reg   [10:0] i_fu_52;
wire   [10:0] add_ln41_fu_98_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln41_fu_92_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln41_reg_136 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln41_reg_136 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln41_fu_92_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln41_reg_136 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln41_reg_136 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln41_fu_98_p2 = (ap_sig_allocacmp_i_2 + 11'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln41_reg_136 == 1'd0) & (m_axi_BUS0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln41_reg_136 == 1'd0) & (m_axi_BUS0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln41_reg_136 == 1'd0) & (m_axi_BUS0_RVALID == 1'b0));
end
...
assign icmp_ln41_fu_92_p2 = ((ap_sig_allocacmp_i_2 == 11'd1024) ? 1'b1 : 1'b0);

assign internal_bram_Addr_A = internal_bram_Addr_A_orig << 32'd2;

assign internal_bram_Addr_A_orig = zext_ln41_fu_115_p1;

assign internal_bram_Din_A = BUS0_addr_read_reg_140;
...
assign zext_ln41_fu_115_p1 = i_2_reg_131_pp0_iter1_reg;

endmodule //read_romcode_read_romcode_Pipeline_VITIS_LOOP_41_1
