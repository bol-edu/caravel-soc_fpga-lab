...
void XRead_romcode_Set_romcode_to_PS(XRead_romcode *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XRead_romcode_WriteReg(InstancePtr->Control_BaseAddress, XREAD_ROMCODE_CONTROL_ADDR_ROMCODE_TO_PS_DATA, (u32)(Data));
    XRead_romcode_WriteReg(InstancePtr->Control_BaseAddress, XREAD_ROMCODE_CONTROL_ADDR_ROMCODE_TO_PS_DATA + 4, (u32)(Data >> 32));
}

u64 XRead_romcode_Get_romcode_to_PS(XRead_romcode *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRead_romcode_ReadReg(InstancePtr->Control_BaseAddress, XREAD_ROMCODE_CONTROL_ADDR_ROMCODE_TO_PS_DATA);
    Data += (u64)XRead_romcode_ReadReg(InstancePtr->Control_BaseAddress, XREAD_ROMCODE_CONTROL_ADDR_ROMCODE_TO_PS_DATA + 4) << 32;
    return Data;
}

void XRead_romcode_Set_cmd(XRead_romcode *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XRead_romcode_WriteReg(InstancePtr->Control_BaseAddress, XREAD_ROMCODE_CONTROL_ADDR_CMD_DATA, Data);
}

u32 XRead_romcode_Get_cmd(XRead_romcode *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRead_romcode_ReadReg(InstancePtr->Control_BaseAddress, XREAD_ROMCODE_CONTROL_ADDR_CMD_DATA);
    return Data;
}
