set SynModuleInfo {
  {SRCNAME read_romcode_Pipeline_VITIS_LOOP_47_2 MODELNAME read_romcode_Pipeline_VITIS_LOOP_47_2 RTLNAME read_romcode_read_romcode_Pipeline_VITIS_LOOP_47_2
    SUBMODULES {
  ...
  {SRCNAME read_romcode_Pipeline_VITIS_LOOP_41_1 MODELNAME read_romcode_Pipeline_VITIS_LOOP_41_1 RTLNAME read_romcode_read_romcode_Pipeline_VITIS_LOOP_41_1}
  {SRCNAME read_romcode MODELNAME read_romcode RTLNAME read_romcode IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME read_romcode_BUS1_m_axi RTLNAME read_romcode_BUS1_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
