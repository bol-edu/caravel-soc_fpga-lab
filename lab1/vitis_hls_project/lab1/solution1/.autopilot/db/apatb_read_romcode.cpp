...
#define AUTOTB_TVIN_romcode_to_PS "../tv/cdatafile/c.read_romcode.autotvin_romcode_to_PS.dat"
#define AUTOTB_TVOUT_romcode_to_PS "../tv/cdatafile/c.read_romcode.autotvout_romcode_to_PS.dat"
#define AUTOTB_TVIN_cmd "../tv/cdatafile/c.read_romcode.autotvin_cmd.dat"
#define AUTOTB_TVOUT_cmd "../tv/cdatafile/c.read_romcode.autotvout_cmd.dat"
...
#define AUTOTB_TVIN_BUS1 "../tv/cdatafile/c.read_romcode.autotvin_BUS1.dat"
#define AUTOTB_TVOUT_BUS1 "../tv/cdatafile/c.read_romcode.autotvout_BUS1.dat"
...
#define AUTOTB_TVOUT_PC_BUS1 "../tv/rtldatafile/rtl.read_romcode.autotvout_BUS1.dat"
...
extern "C"
void read_romcode_hw_stub_wrapper(void*, void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_read_romcode_hw(void* __xlx_apatb_param_romcode, void* __xlx_apatb_param_internal_bram, void* __xlx_apatb_param_romcode_to_PS, hls::sim::Byte<4> __xlx_apatb_param_cmd)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_romcode;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_romcode),
#endif
  };
  port0.param = &__xlx_offset_byte_param_romcode;

  hls::sim::Byte<4> __xlx_offset_byte_param_romcode_to_PS;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_romcode_to_PS),
#endif
  };
  port1.param = &__xlx_offset_byte_param_romcode_to_PS;
  ...
  port2.param = &__xlx_apatb_param_cmd;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_BUS0),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_BUS0),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_romcode };
  port3.depth = { 1024 };
  port3.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_BUS1),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_BUS1),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_BUS1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_BUS1),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_BUS1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_BUS1),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_romcode_to_PS };
  port4.depth = { 1024 };
  port4.offset = {  };
  port4.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_internal_bram),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_internal_bram),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_internal_bram),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_internal_bram),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_internal_bram),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_internal_bram),
#endif
#endif
  };
  port5.param = { __xlx_apatb_param_internal_bram };
  port5.depth = { 1024 };
  port5.offset = {  };
  port5.hasWrite = { true };
  ...
  try {
    ...
    read_romcode_hw_stub_wrapper(__xlx_apatb_param_romcode, __xlx_apatb_param_internal_bram, __xlx_apatb_param_romcode_to_PS, __xlx_apatb_param_cmd);
