...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/allen/vitis/Vitis_HLS/2022.2/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 108 "/home/allen/vitis/Vitis_HLS/2022.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
extern "C" {
...
# 15 "src/read_romcode.cpp"
__attribute__((sdx_kernel("read_romcode", 0))) void read_romcode(

    int romcode[1024*4/sizeof(int)],
 int internal_bram[1024*4/sizeof(int)],
 int romcode_to_PS[1024*4/sizeof(int)],
 int cmd


)
{
#line 14 "/home/allen/fsic-lab1/vitis_hls_project/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=read_romcode
# 24 "src/read_romcode.cpp"
...
int i;
 if(cmd==0){
  ...
  VITIS_LOOP_41_1: for(i=0; i < 1024*4/sizeof(int); i++) {
#pragma HLS PIPELINE
 internal_bram[i] = romcode[i];
  }
 }else if(cmd==1){

  VITIS_LOOP_47_2: for(i=0; i < 1024*4/sizeof(int); i++) {
#pragma HLS PIPELINE
