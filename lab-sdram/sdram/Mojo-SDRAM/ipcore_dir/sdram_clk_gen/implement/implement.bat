...
xst -ifn xst.scr
move sdram_clk_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\sdram_clk_gen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sdram_clk_gen_exdes.ucf sdram_clk_gen_exdes

echo 'Running map'
map -timing -pr b sdram_clk_gen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm sdram_clk_gen_exdes -w routed.ncd routed.v
cd ..
