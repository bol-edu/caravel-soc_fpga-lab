...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/fifo.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/exmem.v"]"\
...
set script_file "vvd_caravel_fpga_40MHz.tcl"
