...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mmult.autotvin.dat"
	set constFileTvOut       "mmult.autotvout.dat"
	set constFileHdlTvIn     "mmult.autohdltvin.dat"
	set constFileHdlTvOut    "mmult.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
