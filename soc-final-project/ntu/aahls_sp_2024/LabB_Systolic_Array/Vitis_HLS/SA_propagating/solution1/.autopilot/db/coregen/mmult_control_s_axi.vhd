...
architecture behave of mmult_control_s_axi is
    ...
    constant ADDR_A_ROW_DATA_0 : INTEGER := 16#34#;
    constant ADDR_A_ROW_CTRL   : INTEGER := 16#38#;
    constant ADDR_A_COL_DATA_0 : INTEGER := 16#3c#;
    constant ADDR_A_COL_CTRL   : INTEGER := 16#40#;
    constant ADDR_B_COL_DATA_0 : INTEGER := 16#44#;
    constant ADDR_B_COL_CTRL   : INTEGER := 16#48#;
    ...
    signal int_a_row           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_a_col           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_b_col           : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_A_ROW_DATA_0 =>
                        rdata_data <= RESIZE(int_a_row(31 downto 0), 32);
                    when ADDR_A_COL_DATA_0 =>
                        rdata_data <= RESIZE(int_a_col(31 downto 0), 32);
                    when ADDR_B_COL_DATA_0 =>
                        rdata_data <= RESIZE(int_b_col(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    a_row                <= STD_LOGIC_VECTOR(int_a_row);
    a_col                <= STD_LOGIC_VECTOR(int_a_col);
    b_col                <= STD_LOGIC_VECTOR(int_b_col);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_ROW_DATA_0) then
                    int_a_row(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_a_row(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_COL_DATA_0) then
                    int_a_col(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_a_col(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_B_COL_DATA_0) then
                    int_b_col(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_b_col(31 downto 0));
                end if;
            end if;
        end if;
    end process;
