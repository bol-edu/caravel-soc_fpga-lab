# 0 "counter_la_uart_sdram_wo_burst.c"
# 1 "/home/ubuntu/lab_6_wlos/testbench/uart//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_uart_sdram_wo_burst.c"
# 19 "counter_la_uart_sdram_wo_burst.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
...
# 20 "counter_la_uart_sdram_wo_burst.c" 2
# 1 "../../firmware/user_uart.h" 1
# 21 "counter_la_uart_sdram_wo_burst.c" 2
...
extern int* qsort();
# 50 "counter_la_uart_sdram_wo_burst.c"
void delay(int n);
...
void main()
{
    ...
    int mask;
# 83 "counter_la_uart_sdram_wo_burst.c"
 ...
 initfir();
 fir_excute();
# 164 "counter_la_uart_sdram_wo_burst.c"
 (*(volatile uint32_t*)0x2600000c) = 0xAB410000;

 matmul();
 (*(volatile uint32_t*)0x2600000c) = 0xAB420000;

 qsort();
 (*(volatile uint32_t*)0x2600000c) = 0xAB430000;
# 187 "counter_la_uart_sdram_wo_burst.c"
