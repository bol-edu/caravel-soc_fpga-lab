# 0 "counter_la_dma.c"
# 1 "/home/ubuntu/lab_6_wlos/testbench/uart_dma//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_dma.c"
# 19 "counter_la_dma.c"
...
# 205 "counter_la_dma.c"
    ...
    int32_t *addr_C=C;
    int32_t *addr_q=q;
    (*(volatile uint32_t*)0x30000004)= (int32_t)addr_x;
    (*(volatile uint32_t*)0x30000008)= (int32_t)addr_y;
    (*(volatile uint32_t*)0x30000084)= (int32_t)addr_A;
    (*(volatile uint32_t*)0x30000088)= (int32_t)addr_B;
    (*(volatile uint32_t*)0x3000008c)= (int32_t)addr_C;
    (*(volatile uint32_t*)0x30000080)= (int32_t)addr_q;
 ...
 while(1){if((*(volatile uint32_t*)0x30000000)==4) break;};
# 238 "counter_la_dma.c"
