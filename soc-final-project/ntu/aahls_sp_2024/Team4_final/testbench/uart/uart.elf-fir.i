...
void __attribute__ ( ( section ( ".mprjram" ) ) ) initfir() {
 ...
 (*(volatile uint32_t*)(0x31000010)) = 64;


 for (uint32_t i = 0; i < 11; i++) {
  (*(volatile uint32_t*)((0x31000040 + 4*i))) = taps[i];
 }
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) fir_excute() {
 ...
 (*(volatile uint32_t*)(0x31000000)) = 1;

 uint8_t register t = 0;
 uint8_t register t_save = 0;

 (*(volatile uint32_t*)(0x31000080)) = t;
...
# 42 "fir.c"
 while (t < 64 -1) {
  temp = (*(volatile uint32_t*)(0x31000084));
  (*(volatile uint32_t*)(0x31000080)) = t+1;
  outputsignal[t_save] = temp;
  t = t + 1;
  t_save = t_save + 1;
    }

 outputsignal[64 -2] = (*(volatile uint32_t*)(0x31000084));
 outputsignal[64 -1] = (*(volatile uint32_t*)(0x31000084));




 (*(volatile uint32_t*)(0x31000000));
