...
if { $list_projs eq "" } {
   create_project project_1 -force myproj -part xc7z020clg400-1
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "./vitis_hls_project/hls_caravel_ps.prj/solution1/impl/ip"]" [current_fileset]
...
set obj [get_filesets sources_1]
add_files "./vitis_hls_project/src/mprj_control.v"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mprj_control_1_0, and set properties
  set block_name mprj_control_1
  set block_cell_name mprj_control_1_0
  if { [catch {set mprj_control_1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mprj_control_1_0 eq "" } {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net caravel_ps_0_mprj_in [get_bd_pins caravel_ps_0/mprj_in] [get_bd_pins mprj_control_1_0/mprj_i]
  connect_bd_net -net mprj_control_1_0_mprj_en [get_bd_pins caravel_ps_0/mprj_en] [get_bd_pins mprj_control_1_0/mprj_en]
  connect_bd_net -net mprj_control_1_0_mprj_o [get_bd_pins caravel_ps_0/mprj_out] [get_bd_pins mprj_control_1_0/mprj_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins caravel_ps_0/ap_clk] [get_bd_pins mprj_control_1_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins caravel_ps_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "$./myproj/project_1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
